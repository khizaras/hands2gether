	...
	return (
		<ConfigProvider theme={{ token: H2GTheme.token }}>
			<div className="container">
				<section className="new-login-page">
					<div className="content">
						<div className="logo">
							<img src={logo} alt="h2gfit-logo" />
						</div>
						<Tabs
							type="line"
							onChange={(key) => setState({ ...state, currenttab: key })}
							...
							items={[
								...
								},
								{
									...
									children: <SignupForm state={state} setState={setState} />,
								},
							]}
						/>
					</div>
	...
	return (
		<div className="signup">
			...
			<Button
				...
				type="link"
				onClick={() => {
					setState({ ...state, currenttab: "signin" });
					console.log({ state });
				}}
			>
